...
export default async function page() {
	return (
		<main className="  bg-blueCl ">
			<div className="container max-w-[90%] mx-auto flex items-center justify-center min-h-screen gap-12">
				...
				<div className="md:w-1/2">
					<Card className="max-w-[400px]">
						...
						<CardContent className="flex flex-col items-center text-center gap-6">
							...
							<p>
								Podes registrarte con una cuenta de gmail para poder formar
								parte de este espacio y acompañarte día a día
							</p>
